...
contract DataStructure{
    ...
    struct Snapshot {
        uint256 balance;
        bool isExist;
        uint8 withdrawFlag;  //0 no withdraw,1 withdrawing 2 withdrawn
    }
    
    //Snapshot mapping  address => version => snapshot struct
    mapping(address => mapping(uint64 => Snapshot)) userSnapShots;
